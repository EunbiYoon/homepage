...
FL_table=ax[0,1].table(cellText=FYear.values.astype(int),rowLabels=FYear.index,colLabels=FYear.columns,rowColours=np.full(12,'#D5DEDE'),colColours=col_colours,loc='left',cellLoc='center')
...
# TL 테이블 생성
ax[1,1].set_axis_off()
TL_table=ax[1,1].table(cellText=TYear.values.astype(int),rowLabels=TYear.index,colLabels=TYear.columns,rowColours=np.full(12,'#D5DEDE'),colColours=col_colours,loc='left',cellLoc='center')
