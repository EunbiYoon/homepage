...
train_dataset=train.flow_from_directory(r'train/',target_size=(200,200),batch_size=3,class_mode='binary')
validation_dataset=validation.flow_from_directory(r'train/',target_size=(200,200),batch_size=3,class_mode='binary')
